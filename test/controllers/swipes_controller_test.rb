...
class SwipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create swipe" do
    assert_difference('Swipe.count') do
      post swipes_url, params: { swipe: { account_id: @swipe.account_id, liked: @swipe.liked, project_id: @swipe.project_id } }
    end
  ...
  test "should update swipe" do
    patch swipe_url(@swipe), params: { swipe: { account_id: @swipe.account_id, liked: @swipe.liked, project_id: @swipe.project_id } }
